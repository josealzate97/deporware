        ...
        <div class="login-panel login-panel--brand">
            ...
            <div class="brand-content">
                ...
                <h1 class="brand-title">
                    <img src="{{ Vite::asset('resources/images/tab_icon.png') }}" alt="Logo deporware" class="brand-title-logo">
                    <span>Deporware</span>
                </h1>
            ...
            <div class="login-card">
                ...
                <div class="login-card__brand">
                    <div class="login-hero-icon login-hero-icon--sm">
                        <img src="{{ Vite::asset('resources/images/tab_icon.png') }}" alt="Logo deporware" class="login-card-logo">
                    </div>
                    <div>
