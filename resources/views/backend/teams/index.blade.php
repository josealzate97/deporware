                ...
                <div class="info-panel modal-theme-mint" :class="open ? 'is-open' : ''" x-show="open" x-transition>
                    <div class="info-header">
                        <div class="modal-theme-header-copy">
                            <div class="modal-theme-header-title">DETALLE DE LA PLANTILLA</div>
                            <div class="modal-theme-header-subtitle">Información general, jugadores, partidos y entrenamientos</div>
                        </div>
