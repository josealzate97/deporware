            ...
            <div class="card p-0 mt-4 section-card">
                ...
                <div class="players-toolbar">
                    ...
                    <div class="players-toolbar-meta p-3">
                        @php($matchesBaseQuery = request()->except('page'))
                ...
                @if(($activeView ?? 'list') === 'calendar')
                    @include('backend.matches.calendar')
                @else
                ...
                <div class="info-panel modal-theme-mint" :class="open ? 'is-open' : ''" x-show="open" x-transition>
                    <div class="info-header">
                        <div class="modal-theme-header-copy">
                            <div class="modal-theme-header-title">DETALLE DEL PARTIDO</div>
                            <div class="modal-theme-header-subtitle">Resumen general y valoraciones del encuentro</div>
                        </div>
