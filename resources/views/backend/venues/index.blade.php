    ...
    <div class="container-fluid p-4">
        ...
        >
            ...
            <form class="section-toolbar" method="GET" action="{{ route('venues.index') }}">
                ...
                <a href="{{ route('venues.index') }}" class="btn btn-sm section-clear-btn">
            ...
            <div class="info-panel modal-theme-mint" :class="open ? 'is-open' : ''" x-show="open" x-transition>
                <div class="info-header">
                    <div class="modal-theme-header-copy">
                        <div class="modal-theme-header-title">DETALLE DE LA SEDE</div>
                        <div class="modal-theme-header-subtitle">Información general, ubicación y equipos asociados</div>
                    </div>
